#!/bin/bash
#
#SBATCH --job-name=swinunet_B3_full
#
...
#
#SBATCH --output=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/swinunet_B3_full.log
#SBATCH --error=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/swinunet_B3_full.err
#
