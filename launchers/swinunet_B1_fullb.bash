#!/bin/bash
#
#SBATCH --job-name=swinunet_B1_fullb
#
...
#
#SBATCH --output=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/swinunet_B1_fullb.log
#SBATCH --error=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/swinunet_B1_fullb.err
#
