#!/bin/bash
#
#SBATCH --job-name=swinunet_B3_fullb
#
...
#
#SBATCH --output=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/swinunet_B3_fullb.log
#SBATCH --error=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/swinunet_B3_fullb.err
#
