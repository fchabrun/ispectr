...
#
#SBATCH --output=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/mednext_B.log
#SBATCH --error=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/mednext_B.err
#
