#!/bin/bash
#
#SBATCH --job-name=swinunet_B1_full
#
...
#
#SBATCH --output=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/swinunet_B1_full.log
#SBATCH --error=/lustre/fswork/projects/rech/ild/uqk67mt/ispectr/logs/swinunet_B1_full.err
#
