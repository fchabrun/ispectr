...
PATH_OUT = 'C:/Users/admin/Documents/Capillarys/temp2021/result_arrays'
...
# load arrays
# file = 'seg3d-3D-l-binary_crossentropy-bs-8-bl-4-w--1-k-3-f16-d-0.1-bn-True_test.npy'
# file = 'seg3d-3D-l-binary_crossentropy-bs-8-bl-4-w-1-k-3-f16-d-0.1-bn-True_test.npy'
# file = 'seg3d-3D-l-binary_crossentropy-bs-8-bl-4-w-2-k-3-f16-d-0.1-bn-True_test.npy'
# file = 'seg3d-3D-l-binary_crossentropy-bs-8-bl-4-w-3-k-3-f16-d-0.1-bn-True_test.npy'
# file = 'seg3d-3D-l-binary_crossentropy-bs-8-bl-4-w-4-k-3-f16-d-0.1-bn-True_test.npy'

for file in [f for f in os.listdir(PATH_OUT) if f[-9:]=="_test.npy"]:
    print("For file: <{}>:".format(file))
    
    y_test_raw_ = np.load(os.path.join(PATH_OUT, file))
