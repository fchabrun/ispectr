...
class ITGenerator(tf.keras.utils.Sequence):
    def __init__(self, x, y, batch_size = 8, shuffle=False, add_fake_mspikes=None, add_fake_flcs=None, add_noise=None, add_shifting=None, seed=42, ford5Pchannel=False):
...
train_gen = ITGenerator(x=x_train, y=y_train, batch_size=FLAGS.batch_size,
                        ...
                        seed = 0,
                        ford5Pchannel = True) # for my own special u-net only, you should set this to false
...
if debug_mode==1:
    ...
    for sample_ind in range(train_gen.batch_size): # which sample to plot
